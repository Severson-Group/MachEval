...
from mach_eval.machines.radial_machines import Stator, Shaft, Square_SynR_Rotor_Iron

__all__ = ['Square_SynR_Machine']

class Square_SynR_Machine(Machine, Shaft, Square_SynR_Rotor_Iron, Stator, Winding):
    ...
    def __init__(
        ...
        """Creates a Square_SynR_Machine object
        Keyword Argumets:
            machine_geometry_dict: dict
            materials_dict: dict
            winding_dict: dict
        Return Values
            machine: Square_SynR_Machine
        """
        cls = Square_SynR_Machine
    ...
    def required_dimensions():
        req_dims = ("l_st",)
        for cl in Square_SynR_Machine.__bases__:
